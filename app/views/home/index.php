...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Sora:wght@300;400;600;700&family=Geist:wght@400;500;600;700&display=swap"
    rel="stylesheet">
...
<body class="bg-white text-gray-900 antialiased">
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 bg-[#6b7a2a] text-white shadow-lg">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center gap-10">
          <a href="#inicio"
            class="text-sm font-semibold hover:opacity-90 transition"><?php _e('home.nav.home', 'Inicio'); ?></a>
          <a href="#como-funciona"
            class="text-sm font-semibold hover:opacity-90 transition"><?php _e('home.nav.how_it_works', 'Como funciona'); ?></a>
          <a href="#beneficios"
            class="text-sm font-semibold hover:opacity-90 transition"><?php _e('home.nav.benefits', 'Beneficios'); ?></a>
          <a href="<?= BASE_URL ?>/tienda"
            class="text-sm font-semibold hover:opacity-90 transition"><?php _e('home.nav.store', 'Tienda'); ?></a>
        </div>
        ...
        <div class="hidden md:flex items-center gap-3">
          ...
          <div id="language-switcher" class="relative">
            <button id="language-button" class="flex items-center gap-2 hover:opacity-90 transition focus:outline-none"
              aria-expanded="false">
            ...
            <div id="language-dropdown"
              ...
              <a href="?lang=es" class="language-option flex items-center px-4 py-2 text-sm hover:bg-gray-100">
              ...
              <a href="?lang=en" class="language-option flex items-center px-4 py-2 text-sm hover:bg-gray-100">
                <span class="w-5 h-4 mr-2 rounded-sm overflow-hidden">
          ...
          <a href="<?= BASE_URL ?>/login"
            class="inline-flex items-center px-3 py-2 text-sm font-semibold hover:opacity-90 transition">
        ...
        <button id="hamburger-btn"
          class="md:hidden flex items-center justify-center w-10 h-10 rounded-lg hover:bg-white/10 transition focus:outline-none"
    ...
    <div id="mobile-menu" class="mobile-menu">
      <div class="px-4 pt-2 pb-6 space-y-3">
        ...
        <a href="<?= BASE_URL ?>/tienda"
          class="block w-full px-5 py-3 bg-[#e6efd8] text-[#334015] font-bold rounded-full hover:brightness-95 transition text-center">
          <?php _e('home.nav.view_products', 'Ver productos'); ?>
        </a>
        ...
        <div class="flex gap-2 pt-2">
          <a href="?lang=es"
            class="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-white/10 rounded-lg hover:bg-white/20 transition">
  ...
  <section id="inicio" class="relative pt-16">
    <div class="relative h-[420px] sm:h-[460px] md:h-[520px] lg:h-[560px]">
      ...
      <div class="absolute inset-0 bg-cover bg-center"
        style="background-image: url('<?= BASE_URL ?>/uploads/image/fondo.jpeg');"></div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div class="lg:col-span-3">
            <div class="relative -mt-28 md:-mt-32 lg:-mt-36">
              <img src="<?= BASE_URL ?>/uploads/image/mayor.png" alt="Alcalde"
          ...
          <div class="lg:col-span-6">
            <div class="grid grid-cols-3 gap-4">
              <div class="rounded-xl overflow-hidden shadow-sm">
                <img src="<?= BASE_URL ?>/uploads/image/galeria-1.jpg" alt="Galería 1"
                  class="w-full h-28 md:h-32 object-cover">
              </div>
              <div class="rounded-xl overflow-hidden shadow-sm">
                <img src="<?= BASE_URL ?>/uploads/image/galeria-2.jpg" alt="Galería 2"
                  class="w-full h-28 md:h-32 object-cover">
              </div>
              <div class="rounded-xl overflow-hidden shadow-sm">
                <img src="<?= BASE_URL ?>/uploads/image/galeria-3.jpg" alt="Galería 3"
                  class="w-full h-28 md:h-32 object-cover">
              </div>
            </div>
          </div>
        ...
        <div class="mt-4 md:mt-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div class="w-full md:w-auto md:pl-10 lg:pl-16">
            <img src="<?= BASE_URL ?>/uploads/image/alcalde-brand.png" alt="Brand Alcalde"
              class="h-16 md:h-20 object-contain">
          </div>

          <img src="<?= BASE_URL ?>/uploads/image/alcaldia-logo.jpeg" alt="Logo Alcaldía"
  ...
  <section id="como-funciona" class="relative">
    <div class="relative py-5 md:py-8">
      ...
      <div class="absolute inset-0 bg-cover bg-center"
        style="background-image:url('<?= BASE_URL ?>/uploads/image/como-funciona.jpeg');"></div>
      <div class="absolute inset-0 bg-black/35"></div>
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div class="rounded-2xl overflow-hidden bg-white/10 backdrop-blur border border-white/15">
            <img src="<?= BASE_URL ?>/uploads/image/como-1.jpg" alt="Paso visual 1" class="w-full h-48 object-cover">
            <div class="p-4 text-white flex items-center gap-3">
              ...
              <span
                class="font-semibold"><?php _e('home.how_it_works.steps.explore.title', 'Explora Productos'); ?></span>
            </div>
          </div>

          <div class="rounded-2xl overflow-hidden bg-white/10 backdrop-blur border border-white/15">
            <img src="<?= BASE_URL ?>/uploads/image/como-2.jpg" alt="Paso visual 2" class="w-full h-48 object-cover">
            <div class="p-4 text-white flex items-center gap-3">
              <div class="w-10 h-10 rounded-full bg-white/15 flex items-center justify-center">
                <!-- Placeholder icon -->
              ...
              <span
                class="font-semibold"><?php _e('home.how_it_works.steps.contact.title', 'Contacta al Productor'); ?></span>
            </div>
          </div>

          <div class="rounded-2xl overflow-hidden bg-white/10 backdrop-blur border border-white/15">
            <img src="<?= BASE_URL ?>/uploads/image/como-3.jpg" alt="Paso visual 3" class="w-full h-48 object-cover">
            <div class="p-4 text-white flex items-center gap-3">
              <div class="w-10 h-10 rounded-full bg-white/15 flex items-center justify-center">
                <!-- Placeholder icon -->
              ...
              <span
                class="font-semibold"><?php _e('home.how_it_works.steps.receive.title', 'Recibe tus Productos'); ?></span>
            </div>
          </div>
        </div>
        ...
        <div class="mt-14 grid md:grid-cols-3 gap-8 items-start">
          <div class="rounded-3xl bg-[#2f3a12] text-white p-8 shadow-lg">
            <h3 class="text-xl font-extrabold mb-3">
              <?php _e('home.how_it_works.steps.explore.title', 'Explora Productos'); ?></h3>
          ...
          <div class="rounded-3xl bg-[#2f3a12] text-white p-8 shadow-lg">
            <h3 class="text-xl font-extrabold mb-3">
              <?php _e('home.how_it_works.steps.contact.title', 'Contacta al Productor'); ?></h3>
            <p class="text-white/90 leading-relaxed">
          ...
          <div class="rounded-3xl bg-[#2f3a12] text-white p-8 shadow-lg">
            <h3 class="text-xl font-extrabold mb-3">
              <?php _e('home.how_it_works.steps.receive.title', 'Recibe tus Productos'); ?></h3>
            <p class="text-white/90 leading-relaxed">
  ...
  <section id="beneficios" class="relative">
    <div class="relative py-10 md:py-14">
      <div class="absolute inset-0 bg-cover bg-center"
        style="background-image:url('<?= BASE_URL ?>/uploads/image/beneficios-bg.jpg');"></div>
        ...
        <div class="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <div class="lg:col-span-6 space-y-6">
            <div class="flex gap-4 text-white">
              ...
              <div>
                <h4 class="text-lg font-extrabold">
                  <?php _e('home.benefits.items.fresh_products.title', 'Productos Frescos'); ?></h4>
                <p class="text-white/90">
                  <?php _e('home.benefits.items.fresh_products.description', 'Directamente del campo a tu mesa, sin intermediarios'); ?>
                </p>
              </div>
            </div>
            ...
            <div class="flex gap-4 text-white">
              ...
              <div>
                <h4 class="text-lg font-extrabold">
                  <?php _e('home.benefits.items.fair_prices.title', 'Precios Justos'); ?></h4>
                <p class="text-white/90">
                  <?php _e('home.benefits.items.fair_prices.description', 'Mejores precios para la comunidad y productores locales'); ?>
                </p>
              </div>
            </div>
            ...
            <div class="flex gap-4 text-white">
              ...
              <div>
                <h4 class="text-lg font-extrabold">
                  <?php _e('home.benefits.items.municipal_support.title', 'Apoyo Municipal'); ?></h4>
                <p class="text-white/90">
                  <?php _e('home.benefits.items.municipal_support.description', 'Iniciativa de la Alcaldía de Santa Ana para fortalecer el sector agrícola'); ?>
                </p>
              </div>
            </div>
            ...
            <div class="flex gap-4 text-white">
              ...
              <div>
                <h4 class="text-lg font-extrabold">
                  <?php _e('home.benefits.items.transparency.title', 'Transparencia Total'); ?></h4>
                <p class="text-white/90">
                  <?php _e('home.benefits.items.transparency.description', 'Conoce el origen de cada producto de nuestros agricultores'); ?>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="lg:col-span-6">
            <div class="rounded-3xl bg-[#dfe8cf] p-8 md:p-10 shadow-xl">
              ...
              <div class="text-center">
                <a href="<?= BASE_URL ?>/registro/informacion"
      ...
      <div class="border-t border-white/10 pt-5">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
          ...
          <div class="flex flex-wrap justify-center gap-5 text-sm">
            <a href="<?= BASE_URL ?>/tienda"
              class="hover:text-white transition-colors"><?php _e('home.footer.links.store', 'Tienda'); ?></a>
            <a href="#como-funciona"
              class="hover:text-white transition-colors"><?php _e('home.footer.links.how_it_works', 'Cómo Funciona'); ?></a>
            <a href="#beneficios"
              class="hover:text-white transition-colors"><?php _e('home.footer.links.benefits', 'Beneficios'); ?></a>
            <a href="<?= BASE_URL ?>/login"
              class="hover:text-white transition-colors"><?php _e('home.footer.links.login', 'Iniciar Sesión'); ?></a>
          </div>
